    ...
    return (
        <div>
            <div className='container px-18 mx-auto py-7'>
                ...
                {/* FIXED: responsive grid + key error */}
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
                    {serviceData.map(s =>
                        <div
                            key={s.id}   // 🔥 key warning fixed
                            className='border border-gray-200 shadow-2xl rounded-md px-8 py-6'
                        >
                            <div className='grid justify-center pb-2 font-bold text-4xl cp'>
                                {s.icon}
                            </div>
